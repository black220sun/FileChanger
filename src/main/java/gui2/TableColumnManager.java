        ...
        implements MouseListener, ActionListener, TableColumnModelListener, PropertyChangeListener
{
    ...
    public void reset()
    {
        ...
        hiddenColumns = new ArrayList<Integer>();
    ...
    public void hideColumn(TableColumn column)
    {
        ...
        tcm.addColumnModelListener( this );
        hiddenColumns.add(column.getModelIndex());
    }
    ...
    public boolean isHidden(Integer i) {
        return hiddenColumns.contains(i);
    }
    ...
    private void showColumn(TableColumn column)
    {
        ...
        hiddenColumns.remove(column.getModelIndex());
